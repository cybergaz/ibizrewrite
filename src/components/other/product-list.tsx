            ...
            <div className="grid grid-cols-4 gap-y-10 gap-x-12">
                {
                    products?.map((product, index) => (
                        <div
                            key={index}
                            className=" w-[15rem] h-[18rem] p-3 flex flex-col justify-between animate-fade-in-scale delay-500 shadow-2xl gap-2 bg-accent-light-gray/25 border border-black/5 rounded-2xl">
