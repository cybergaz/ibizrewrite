...
export default function ServicesPage() {
    return (
        <div className="space-y-8 py-24">
            ...
            <div className="max-w-[85rem] mx-auto bg-white/50 rounded-3xl p-10 flex gap-10 justify-between items-center">
                <div className="w-[50%] flex flex-col gap-10">
                    <h1 className="text-3xl font-medium">USA Imports to India</h1>
                    <p>
                ...
                <Image src="/images/illustration4.jpg" alt="hero image" className="w-[50%] rounded-xl" width={500} height={500} />
            </div>
            ...
            <div className="max-w-[85rem] mx-auto bg-white/50 rounded-3xl p-10 flex gap-10 justify-between items-center">
                <Image src="/images/illustration4.jpg" alt="hero image" className="w-[50%] rounded-xl" width={500} height={500} />
                <div className="w-[50%] flex flex-col gap-10">
                    <h1 className="text-3xl font-medium">Global Imports</h1>
                    <p>
            ...
            <div className="max-w-[85rem] mx-auto bg-white/50 rounded-3xl p-10 flex gap-10 justify-between items-center">
                <div className="w-[50%] flex flex-col gap-10">
                    <h1 className="text-3xl font-medium">Door to Door Imports</h1>
                    <p>
